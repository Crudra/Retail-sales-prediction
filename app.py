...
side_bg = r'C:\Users\RUDRA\project\capstone6\dw.png'
sidebar_bg(side_bg)
...
# load store dataset
data = pd.read_csv(r"C:\Users\RUDRA\project\capstone6\data.csv")
...
if button:
    with st.spinner(text='Processing...'):
        ...
        with open(r"C:\Users\RUDRA\project\capstone6\Regression_Model2.pkl", 'rb') as f:
            model = pickle.load(f)
...
if button2:
    with st.spinner(text='Processing...'):
        ...
        # load the regression pickle model
        with open(r"C:\Users\RUDRA\project\capstone6\Regression_Model1.pkl", 'rb') as f:
            model = pickle.load(f)
